...
const OtpInput = ({
	...
	const inputOnChange = (
		...
		let targetValue: string = target.value.trim().toUpperCase();
		...
		const targetValueLength: number = targetValue.length;
		...
		<div className='flex flex-row gap-2 px-1'>
			{valueItems.map((digit, idx) => (
				<input
					...
					className='rounded-md text-center text-xl font-semibold px-1'
					value={digit}
